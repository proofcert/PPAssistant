...
store_kc (interact (unary (storeI I) L) Com [formula FI I|Choice] FI E) F_ I (interact L Com Choice (u FI) E).
...
all_kc (interact (unary allI L) Com [eigen_var FI F|Choice] FI E) F (Eigen\ (interact L) Com Choice (u FI) [eigen FI Eigen| E]).
