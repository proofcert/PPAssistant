...
andNeg_kc (interact (binary (andNegI FI) L1 L2) Com FI E1 E2) F (interact L1 Com (l FI) E1 E2) (interact L2 Com (r FI) E1 E2).
...
dia_ke (interact (unary (diaI FI) L) [auto|Com] FI E1 E2) _ T (interact L Com (u FI) E1 E2) :-
  apply_vars T E1 T'.
